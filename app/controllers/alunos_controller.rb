class AlunosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to aluno_url, notice: "Aluno was successfully destroyed." }
  ...
  private
    ...
    def aluno_params
      params.require(:aluno).permit(:nome, :email, :telefone, :curso,
      curriculo_attributes: [:id, :resumo, :idioma, :formacao, :conhecimento, :outro])
    end
end
